...
/**
 * Orquestador del agente vía Ollama `/api/chat` con `format: "json"`.
 * Modelo por defecto `llama3.1:8b` (`OLLAMA_AGENT_MODEL`).
 */
export function createOllamaJsonLlm(options?: {
  baseUrl?: string;
  model?: string;
}): LlmClient {
